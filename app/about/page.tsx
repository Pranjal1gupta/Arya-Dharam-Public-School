...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      ...
      description:
        'At Arya Dharam Public School, we believe every child has the potential to shine. Our mission is to guide, nurture, and inspire each student to explore, achieve, and lead with confidence.',
  ...
  const faculty = [
    {
      ...
      role: 'Principal',
      img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6mIaDnaxu6GGE1FtuGkfpVYBAxh1Bwg&s',
    ...
    },
    {
      name: 'Ms. Nisha Patel',
      role: 'Vice Principal',
      img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsyjGOwWv3wBcNUbD5gfHRqkhbYMSA&s',
    ...
    },
    {
      ...
      img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsANjHOWtL2OcU5lHQaImKUbN0buYg&s',
    ...
    },
    {
      ...
      img: 'https://e d-tbn0.gstatic.com/images?q=tbn:ANd9GcTz2KFIDy1aRwV2HFnCcVvNHPDb82VujJsXzQ&s',
      ...
      <main className="flex-grow pt-24">
        ...
        <section className="relative py-28 text-center bg-gradient-to-r from-blue-200 via-indigo-400 to-purple-700 text-white overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-6">
            ...
            >
              About <span className="text-amber-300">Arya Dharam Public School</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <SectionWrapper id="why-us" className="py-20">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold mb-6 text-gray-900">
              Why Choose <span className="text-blue-700">Arya Dharam Public School?</span>
            </h2>
        ...
        <div className="text-center py-16 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700">
          <h2 className="text-3xl font-bold text-white mb-6">Ready to Join Our Arya Dharam Family?</h2>
          <Link
            href="/admissions"
