...
export default function CoursesPage() {
  ...
  const courses = [
    ...
    },
    {
      ...
      fullDescription:
        'Mathematics at Arya Dharam Public School focuses on analytical thinking, quantitative reasoning, and conceptual clarity. Through puzzles, logic games, and applied math projects, students enjoy learning numbers in fun, interactive ways.',
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                At Arya Dharam Public School, we provide a well-rounded curriculum that empowers students with knowledge,
