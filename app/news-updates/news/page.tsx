...
export default function News() {
  const allNews = [
    ...
    },
    {
      ...
      desc: 'Arya Dharam Public School launches a new merit-based scholarship for high-performing students.',
      details:
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      >
        <div className="absolute inset-0 text-white bg-gradient-to-r from-blue-200 via-indigo-400 to-purple-700 overflow-hidden flex flex-col items-center justify-center text-center px-4">
          ...
          >
            Stay informed with the latest happenings, announcements, and achievements from Arya Dharam Public School.
          </motion.p>
        </div>
      </section>
