...
export default function About() {
  const cards = [
    ...
    },
    {
      ...
      description:
        'Welcome to Arya Dharam Public School! We are committed to unlocking each student\'s potential through personalized attention, modern facilities, and a supportive learning environment.',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 sm:p-8 md:p-12 text-white">
          <div className="max-w-3xl mx-auto text-center">
            <h3 className="text-2xl sm:text-3xl font-bold mb-4">Why Choose Arya Dharam Public School?</h3>
