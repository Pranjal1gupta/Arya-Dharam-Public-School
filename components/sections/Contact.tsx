  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Address',
      content: 'BLOCK-172, GNIDA BHS-16 HOUSING, Sector, MU ll, Greater Noida, Uttar Pradesh 201310',
      color: 'from-blue-500 to-blue-600',
    },
    {
      icon: Phone,
      title: 'Phone',
      content: '+91 99998 50071',
      color: 'from-green-500 to-green-600',
    },
    {
      icon: Mail,
      title: 'Email',
      content: 'info@aryadharam.edu',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <AnimatedCard delay={0.2} className="p-6 md:p-8">
            ...
            <div className="rounded-lg overflow-hidden h-[300px] md:h-[400px] mb-4">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3772.0163612441647!2d77.57241117577914!3d28.474931775751198!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390c9550c3aca215%3A0x253c653cfbdac0f9!2sArya%20Dharam%20Public%20School!5e1!3m2!1sen!2sin!4v1767645804739!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
